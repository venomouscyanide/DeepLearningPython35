...
if __name__ == '__main__':
    ...
    # using rectified linear units with l2 regularization
    net = Network([
        ConvPoolLayer(image_shape=(mini_batch_size, 1, 28, 28),
                      filter_shape=(20, 1, 5, 5),
                      poolsize=(2, 2),
    ...
    # aritifically expanding the data to 250K
    # this will not work. Not able to run expand_mnist.py due to pickle encoding error.
